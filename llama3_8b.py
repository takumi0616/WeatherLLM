...
def run_all_pipeline(args: argparse.Namespace) -> None:
    ...
    base_model, base_tokenizer = load_model_and_tokenizer_from_local(
        local_model_dir, device_map, dtype, hf_token, for_training=False
    )
    ...
    base_model2, tok2 = load_model_and_tokenizer_from_local(local_model_dir, device_map, dtype, hf_token, for_training=False)
    try:
