...
INSTRUCTION_PATH = PROMPT_DIR / "v1_instruction.txt"
...
MODEL_NAME = "gpt-4o"  # Updated to a current vision-capable model
...
def main():
    parser = argparse.ArgumentParser(description="v1: 画像(天気図) + 指示文でコメント生成 (Vision)")
