...
SECTIONS: list[Section] = [
    ...
    Section(
        title="6. 気団",
        description="日本の天候を支配する主要気団。",
        keywords=[
            Keyword(name="気団", note="性質の似た空気のかたまり。気象解説の基礎概念。"),
            Keyword(name="シベリア気団", note="冬の寒冷乾燥気団。"),
            Keyword(name="小笠原気団", note="夏の高温多湿な海洋性気団。"),
            Keyword(name="オホーツク海気団", note="梅雨期の冷涼湿潤気団。"),
            Keyword(name="揚子江気団", note="春・秋に移動性高気圧を作る大陸性気団。"),
            Keyword(name="赤道気団", note="夏に低緯度から流入する高温多湿気団。"),
        ],
    ),
    Section(
        title="7. 空気の性質（暖気・寒気・湿り）",
    ...
    Section(
        title="10. 雲・雷・降水",
        description="雲の種類および雨・雷に関する表現。",
        keywords=[
            Keyword(name="雲", note="降水雲全般を指す総称。"),
            Keyword(name="積乱雲", note="雷雨・突風・大雨を起こす雲。"),
            Keyword(name="積雲", note="晴天時にも見られる対流雲。"),
            Keyword(name="巻雲", note="高度の高い氷晶雲。"),
            Keyword(name="高積雲", note="中層の塊状雲。"),
            Keyword(name="高層雲", note="中層の層状雲。温暖前線の指標。"),
            Keyword(name="乱層雲", note="持続的な雨を降らせる雲。"),
            Keyword(name="層積雲", note="下層の塊状雲。"),
            Keyword(name="層雲", note="霧に近い下層の層状雲。"),
            Keyword(name="雨雲", note="雨を降らせる雲の俗称。"),
            Keyword(name="雷雨", note="積乱雲に伴う雨と雷。"),
            Keyword(name="雷", note="放電現象。大気不安定時に発生。"),
            Keyword(name="落雷", note="雷の地表への放電。"),
            Keyword(name="雨", note="液体降水。最も基本的な降水表現。"),
            Keyword(name="降水", note="雨・雪・あられ等の総称。"),
            Keyword(name="降水量", note="一定時間の降水量を示す気象観測値。"),
            Keyword(name="雨量", note="降水量の通称表現。"),
            Keyword(name="大雨", note="一般に1時間20mm以上、または期間降水量が多い雨。"),
            Keyword(name="豪雨", note="大雨をやや強調した表現。"),
            Keyword(name="集中豪雨", note="狭い範囲に短時間で降る激しい雨。"),
            Keyword(name="局地的", note="範囲が限定された強雨・雷雨の修飾語。"),
            Keyword(name="線状降水帯", note="同じ場所に積乱雲が次々と発生し帯状に連なる豪雨。"),
            Keyword(name="にわか雨", note="短時間に降る雨。通り雨。"),
            Keyword(name="通り雨", note="短時間で降りやむ雨。"),
            Keyword(name="小雨", note="弱い雨の表現。"),
            Keyword(name="強い雨", note="気象庁定義: 1時間 20mm以上 30mm未満。"),
            Keyword(name="やや強い雨", note="気象庁定義: 1時間 10mm以上 20mm未満。"),
            Keyword(name="激しい雨", note="気象庁定義: 1時間 30mm以上 50mm未満。"),
            Keyword(name="非常に激しい雨", note="気象庁定義: 1時間 50mm以上 80mm未満。"),
            Keyword(name="猛烈な雨", note="気象庁定義: 1時間 80mm以上。"),
            Keyword(name="霧雨", note="細かい水滴の弱い雨。"),
            Keyword(name="時雨", note="晩秋〜初冬の通り雨。"),
            Keyword(name="ひょう", note="氷の粒（直径5mm以上）。雷雨に伴う。"),
            Keyword(name="あられ", note="氷の粒（直径5mm未満）。"),
            Keyword(name="みぞれ", note="雨と雪が混ざった降水。"),
        ],
    ),
    Section(
        title="11. 雪・降雪",
        description="雪・吹雪などの冬季降雪現象。",
        keywords=[
            Keyword(name="雪", note="固体降水。冬季の代表的天気。"),
            Keyword(name="大雪", note="顕著な降雪。警報・注意報基準は地域別。"),
            Keyword(name="降雪", note="雪が降る現象・量。"),
            Keyword(name="積雪", note="地面に積もった雪の深さ。"),
            Keyword(name="吹雪", note="強風で雪が舞う状態。視程悪化の要因。"),
            Keyword(name="風雪", note="強風と雪を伴う荒天。"),
            Keyword(name="暴風雪", note="暴風と雪が同時に発生する状態。"),
            Keyword(name="なだれ", note="斜面の雪が崩落する現象。"),
            Keyword(name="雪崩", note="なだれの漢字表記。"),
            Keyword(name="着雪", note="電線や樹木に雪が付着する現象。"),
            Keyword(name="着氷", note="物体表面に氷が付着する現象。"),
            Keyword(name="雪雲", note="雪を降らせる雲の俗称。"),
            Keyword(name="ぼたん雪", note="大粒の湿った雪。"),
            Keyword(name="粉雪", note="乾いた細かい雪。"),
            Keyword(name="凍結", note="水が凍る現象。路面凍結等で災害要因。"),
            Keyword(name="路面凍結", note="道路面の凍結。冬季交通災害要因。"),
            Keyword(name="ホワイトアウト", note="吹雪等で視界が完全に失われる現象。"),
        ],
    ),
    Section(
        title="12. 大気の状態",
    ...
    Section(
        title="14. 気温・温度指標",
        description="顕著な高温・低温の指標と温度関連表現。",
        keywords=[
            Keyword(name="気温", note="気象解説の基本要素。"),
            Keyword(name="最高気温", note="日中の最も高い気温。"),
            Keyword(name="最低気温", note="日中の最も低い気温。"),
            Keyword(name="高温", note="平年より顕著に高い気温。"),
            Keyword(name="低温", note="平年より顕著に低い気温。"),
            Keyword(name="夏日", note="日最高気温25℃以上。"),
            Keyword(name="真夏日", note="日最高気温30℃以上。"),
            Keyword(name="猛暑日", note="日最高気温35℃以上。"),
            Keyword(name="熱帯夜", note="日最低気温25℃以上。"),
            Keyword(name="冬日", note="日最低気温0℃未満。"),
            Keyword(name="真冬日", note="日最高気温0℃未満。"),
            Keyword(name="冷え込み", note="夜間の急激な気温低下。"),
            Keyword(name="冷え込む", note="気温が低下する動的表現。"),
            Keyword(name="厳しい暑さ", note="顕著な高温の表現。"),
            Keyword(name="厳しい寒さ", note="顕著な低温の表現。"),
            Keyword(name="平年並み", note="平年値とほぼ同じ。"),
            Keyword(name="平年並", note="平年並みの異表記。"),
            Keyword(name="平年より高い", note="平年値を上回る表現。"),
            Keyword(name="平年より低い", note="平年値を下回る表現。"),
            Keyword(name="平年", note="気候平年値。"),
            Keyword(name="気温差", note="場所・時間による気温の差。"),
            Keyword(name="日較差", note="一日の最高・最低気温の差。"),
            Keyword(name="暑さ", note="高温の感覚的表現。"),
            Keyword(name="寒さ", note="低温の感覚的表現。"),
        ],
    ),
    Section(
        title="15. 季節・梅雨",
    ...
    Section(
        title="16. 風・嵐",
        description="強風・暴風・突風など風の強さ表現。",
        keywords=[
            Keyword(name="風", note="風全般の最も基本的な表現。"),
            Keyword(name="強風", note="平均風速10m/s以上目安。"),
            Keyword(name="暴風", note="平均風速20m/s以上目安。警報基準。"),
            Keyword(name="突風", note="瞬間的に強まる風。"),
            Keyword(name="竜巻", note="積乱雲下の渦巻状激しい上昇気流。"),
            Keyword(name="ダウンバースト", note="積乱雲からの強い下降気流。"),
            Keyword(name="しけ", note="海上の荒天状態。"),
            Keyword(name="風速", note="風の強さを示す気象観測値。"),
            Keyword(name="平均風速", note="一定時間の平均風速。"),
        ],
    ),
    Section(
        title="17. 防災・海洋・災害",
        description="警報・注意報および海洋・水害に関する表現。",
        keywords=[
            Keyword(name="警報", note="重大な災害の恐れがある場合に発表。"),
            Keyword(name="注意報", note="災害の恐れがある場合に発表。"),
            Keyword(name="特別警報", note="数十年に一度の重大な災害が予想される場合。"),
            Keyword(name="大雨警報", note="大雨による災害の警報。"),
            Keyword(name="暴風警報", note="暴風による災害の警報。"),
            Keyword(name="大雪警報", note="大雪による災害の警報。"),
            Keyword(name="波浪警報", note="高波による災害の警報。"),
            Keyword(name="高潮警報", note="高潮による災害の警報。"),
            Keyword(name="洪水警報", note="洪水による災害の警報。"),
            Keyword(name="洪水", note="河川の氾濫等による浸水。"),
            Keyword(name="土砂災害", note="降雨による斜面崩壊・土石流。"),
            Keyword(name="高波", note="大きな波。海上の荒天指標。"),
            Keyword(name="高潮", note="台風・低気圧で海面が上昇する現象。"),
            Keyword(name="うねり", note="風が止んでも残る長い波。"),
            Keyword(name="浸水", note="低地・地下道の冠水。"),
            Keyword(name="氾濫", note="河川水が堤防を越える状態。"),
            Keyword(name="災害", note="気象災害全般。"),
        ],
    ),
    Section(
        title="18. 天気の状態",
        description="晴れ・曇り・雨など天気の基本表現。",
        keywords=[
            Keyword(name="晴れ", note="雲量が少ない天気。"),
            Keyword(name="曇り", note="雲が多い天気。"),
            Keyword(name="快晴", note="雲量が極めて少ない天気。"),
            Keyword(name="薄曇り", note="雲はあるが日が透ける程度の天気。"),
            Keyword(name="晴れ間", note="曇天や雨天の合間の晴れ。"),
            Keyword(name="晴天", note="晴れた日の状態。"),
            Keyword(name="曇天", note="曇った日の状態。"),
            Keyword(name="雨天", note="雨の日の状態。"),
            Keyword(name="一時", note="天気予報用語。短時間の現象を示す。"),
            Keyword(name="時々", note="天気予報用語。断続的な現象を示す。"),
        ],
    ),
    Section(
        title="19. 気象観測値・要素",
        description="気圧・湿度などの観測値表現。",
        keywords=[
            Keyword(name="気圧", note="大気の圧力。気象解説の基本要素。"),
            Keyword(name="hPa", note="ヘクトパスカル。気圧の単位。"),
            Keyword(name="ヘクトパスカル", note="気圧の単位の正式表記。"),
            Keyword(name="湿度", note="空気中の水蒸気量の指標。"),
            Keyword(name="観測", note="気象観測全般。"),
            Keyword(name="アメダス", note="地域気象観測システム。"),
        ],
    ),
    Section(
        title="20. 海洋・地理",
        description="海洋現象および地域・地理的表現。",
        keywords=[
            Keyword(name="海面水温", note="海面の温度。台風発達等に影響。"),
            Keyword(name="黒潮", note="日本の南岸を流れる暖流。"),
            Keyword(name="親潮", note="日本の北東岸を流れる寒流。"),
            Keyword(name="海上", note="海上の天候を示す表現。"),
            Keyword(name="北日本", note="北海道・東北の総称。"),
            Keyword(name="東日本", note="関東甲信・北陸・東海の総称。"),
            Keyword(name="西日本", note="近畿・中国・四国・九州の総称。"),
            Keyword(name="北海道", note="北海道地方。"),
            Keyword(name="本州", note="本州島。"),
            Keyword(name="九州", note="九州地方。"),
            Keyword(name="沖縄", note="沖縄地方。"),
            Keyword(name="関東", note="関東地方。"),
            Keyword(name="東北", note="東北地方。"),
            Keyword(name="近畿", note="近畿地方。"),
            Keyword(name="四国", note="四国地方。"),
            Keyword(name="中国地方", note="中国地方。"),
            Keyword(name="東海", note="東海地方。"),
            Keyword(name="北陸", note="北陸地方。"),
            Keyword(name="信越", note="信越地方。"),
            Keyword(name="甲信", note="甲信地方。"),
            Keyword(name="太平洋側", note="日本列島の太平洋側地域。"),
            Keyword(name="日本海側", note="日本列島の日本海側地域。"),
            Keyword(name="山沿い", note="山岳に沿った地域。"),
            Keyword(name="平野部", note="平野の地域。"),
            Keyword(name="大陸", note="ユーラシア大陸を主に指す。"),
            Keyword(name="朝鮮半島", note="朝鮮半島地域。低気圧通過経路として頻出。"),
        ],
    ),
    Section(
        title="21. 異常気象・気候",
